...
const EditFoodMenuPopup = ({ isOpen, onClose }) => {
    ...
    <Modal show={isOpen} size="4xl" popup onClose={onClose}>
      ...
      <Modal.Body>
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-lg font-semibold">Edit Food Menu</h2>
            <p className="text-sm text-gray-500">
              Edit category of your food menu
            </p>
          </div>
        </div>
...
export default EditFoodMenuPopup;
