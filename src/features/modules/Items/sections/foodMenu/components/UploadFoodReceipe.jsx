...
const UploadFoodReceipeModal = ({ isOpen, onClose, onSubmit }) => {
    ...
    <Modal show={isOpen} size="xl" popup onClose={onClose}>
      ...
      <Modal.Body>
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-lg font-semibold">Upload recipe</h2>
            <p className="text-sm text-gray-500">
              Choose a document of uploading your food recipe.
            </p>
          </div>
        </div>
...
export default UploadFoodReceipeModal;
