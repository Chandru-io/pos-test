...
function EditExpenseItemPopup({ isOpen, onClose }) {
  const handleConfirm = () => {
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center space-x-2">
                <div className=" flex flex-col items-center">
                  <h2 className="text-lg font-semibold">Edit Expense Item</h2>
                  <p className="text-sm text-gray-500">Edit New Expense Item</p>
                </div>
              </div>
            </div>
...
export default EditExpenseItemPopup;
