...
const EditProduction = ({ isOpen, onClose }) => {
        ...
        <Modal.Body>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-primary_button text-white rounded-lg hover:bg-primary_button_hover"
              >
                update
              </button>
            </div>
