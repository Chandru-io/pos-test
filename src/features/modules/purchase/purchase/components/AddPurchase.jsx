        ...
        <Modal.Body>
          <div className="bg-white p-8 w-full">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold">Add Purchase</h2>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <div className="flex items-center border rounded ">
                <input
                  ...
                  className=" rounded-md  p-2 w-full max-w-56"
                />
                <button className="bg-blue-500 text-white px-2  rounded hover:bg-blue-600 scale-95">
                  +
                </button>
              </div>
            ...
            <div className="flex flex-col justify-between items-end mb-6">
              ...
              <div>
                <p className="text-gray-700 font-bold">Paid</p>
                <input
                  type="text"
                  className="border border-gray-300 rounded p-2 w-full mt-1"
                />
              ...
              <div>
                <p className="text-gray-700 font-bold">Due</p>
                <input
                  type="text"
                  className="border border-gray-300 rounded p-2 w-full mt-1"
                />
              ...
              <div className="">
                <p className="text-gray-700 font-bold">Payment Method</p>
