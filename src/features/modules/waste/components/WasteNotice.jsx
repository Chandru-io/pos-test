        ...
        <Modal.Body>
          ...
          <div className="bg-gray-100 p-4 rounded-lg text-sm text-gray-800 overflow-auto">
            ...
            <p className="mt-2">
              ...
              Something like you buy 1 packet Chaomin,{" that's"} weight is 500
              g and you can make 4 dishes. Then enter the consumption 125 g (500
              g / 4 dish=125 g).
            </p>
            <p className="mt-2 font-semibold">
              NB: These are just examples, calculate the consumption on your
              own.
            </p>
          </div>
